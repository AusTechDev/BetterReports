 ...
 * @see ItemStack
 */
@SuppressWarnings({"unused", "WeakerAccess", "deprecated"})
public enum XMaterial {
    ...
    static {
        for (final XMaterial material : VALUES) NAMES.put(material.name(), material);
    }
    ...
    XMaterial(final int data, @NotNull final String... legacy) {
        this.data = (byte) data;
        this.legacy = legacy;
